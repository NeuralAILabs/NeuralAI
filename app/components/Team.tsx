...
function Social({ href, children }: { href: string; children: ReactNode }) {
  return (
    <a href={href} className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#e2d5c0] text-[#1f1410] hover:bg-[#f5e9d3] hover:border-[#b89e8a] transition">
      {children}
    </a>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="px-6 pt-5 pb-6 text-center">
        ...
        <p className="text-sm text-[#b0421a] mt-1 font-medium">{m.role}</p>
