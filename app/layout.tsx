...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${hanken.variable} ${inter.variable} ${poppins.variable} h-full antialiased`}
    >
      <body suppressHydrationWarning className="grain min-h-full flex flex-col bg-background text-foreground">
        {children}
      </body>
    </html>
  );
